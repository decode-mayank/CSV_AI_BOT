...
def resmed_chatbot(user_input, inputs=[]):
    ...
    # Else pass input to the OpenAI Completions endpoint
        ...
        prompt = f"Answer the question only related to the topics of sleep,health,mask and if you're unsure of the answer, say That I have been trained to answer only sleep and health related queries {user_input}"
